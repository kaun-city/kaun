  ...
  return (
    <div className="px-5 py-4 space-y-4 pb-safe-content">
      ...
      {grievances.length > 0 && (
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <p className="text-white/30 text-xs uppercase tracking-wider">Complaint Resolution</p>
            ...
            return (
              <div key={g.year} className="rounded-xl bg-white/5 px-4 py-3 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-white/30 text-xs">{g.total_complaints.toLocaleString("en-IN")} complaints filed</p>
                </div>
      ...
      {sakala && (
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <p className="text-white/30 text-xs uppercase tracking-wider">Sakala Service Delivery</p>

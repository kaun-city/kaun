# Hingoli — Lok Sabha, Maharashtra

_`27-15` · हिंगोली · General seat · 6 assembly segments_

**[Open Hingoli on kaun.city →](https://kaun.city/india/c/27-15)** for the interactive view — the seat
...
| Seat number within the state | 15 |
| Reservation | General (source: `2008-delimitation-order-table-b`) |
| Name (Hindi) | हिंगोली |
| Districts | Yavatmal; Nanded; Hingoli |
| Assembly segments | 6 |
| Wikidata | [Q2912894](https://www.wikidata.org/wiki/Q2912894) |
...
|---:|---|---|---|---|
| 82 | Umarkhed | SC | Yavatmal | agrees |
| 83 | Kinwat | — | Nanded | agrees |
| 84 | Hadgaon | — | Nanded | agrees |
| 92 | Basmath | — | Hingoli | agrees |
| 93 | Kalamnuri | — | Hingoli | agrees |
| 94 | Hingoli | — | Hingoli | agrees |
...
**Aashtikar Patil Nagesh Bapurao** (Shiv Sena) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5640) |
...
| Candidate as named on the affidavit | Aashtikar Patil Nagesh Bapurao |
| Pending criminal cases | none declared |
| Total assets | ₹8.06 Cr |
| Liabilities | ₹88.67 L |
| Education | Graduate — B. Com From Arts, Commerce College Hadgaon Nanded Dr. Babasaheb Marathwada University Aurangabad In The Year 1993-94 |
| Profession (self-declared) | Agriculture And Business |
| Age at nomination | 52 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=2408) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹19.03 Cr | ₹6.75 Cr | ₹12.28 Cr | 35.5% | 104 | 56 | 38 | 2026-09-06 |

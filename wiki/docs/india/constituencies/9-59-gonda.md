# Gonda — Lok Sabha, Uttar Pradesh

_`9-59` · गोंडा · General seat · 5 assembly segments_

**[Open Gonda on kaun.city →](https://kaun.city/india/c/9-59)** for the interactive view — the seat
...
| Seat number within the state | 59 |
| Reservation | General (source: `2008-delimitation-order-table-b`) |
| Name (Hindi) | गोंडा |
| Districts | Balrampur; Gonda |
| Assembly segments | 5 |
| Wikidata | [Q12424329](https://www.wikidata.org/wiki/Q12424329) |
...
|---:|---|---|---|---|
| 293 | Utraula | — | Balrampur | agrees |
| 295 | Mehnaun | — | Gonda | agrees |
| 296 | Gonda | — | Gonda | agrees |
| 300 | Mankapur | SC | Gonda | agrees |
| 301 | Gaura | — | Gonda | agrees |
...
**Kirti Vardhan Singh** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/3926) |
...
| Candidate as named on the affidavit | Kirtivardhan Singh |
| Pending criminal cases | ⚠ 3 |
| Total assets | ₹37.08 Cr |
| Liabilities | ₹1.19 Cr |
| Education | Post Graduate — Master of Science- Geology In 1988 from Lucknow University Lucknow UP |
| Profession (self-declared) | Agriculture, Business , Politician |
| Age at nomination | 58 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7194) |

# Alipurduars — Lok Sabha, West Bengal

_`19-2` · अलीपुरद्वार · Reserved for ST · 7 assembly segments_

**[Open Alipurduars on kaun.city →](https://kaun.city/india/c/19-2)** for the interactive view — the seat
...
| Name (Hindi) | अलीपुरद्वार |
| Districts | Coochbehar; Jalpaiguri |
| Assembly segments | 7 |
| Wikidata | [Q4726846](https://www.wikidata.org/wiki/Q4726846) |
...
|---:|---|---|---|---|
| 9 | TUFANGANJ | — | Coochbehar | agrees |
| 10 | KUMARGRAM | ST | Jalpaiguri | agrees |
| 11 | KALCHINI | ST | Jalpaiguri | agrees |
| 12 | ALIPURDUARS | — | Jalpaiguri | agrees |
| 13 | FALAKATA | SC | Jalpaiguri | agrees |
| 14 | MADARIHAT | ST | Jalpaiguri | agrees |
| 21 | NAGRAKATA | ST | Jalpaiguri | agrees |
...
**Manoj Tigga** (Bharatiya Janata Party) holds this seat.
...
| Profession | TEACHER |
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5596) |
...
| Candidate as named on the affidavit | Manoj Tigga |
| Pending criminal cases | ⚠ 6 |
| Total assets | ₹57.51 L |
| Liabilities | ₹16.03 L |
| Education | Graduate — B.Sc(Bio) from A C College Jalpaiguri Under North Bengal University in the year 1996 |
| Profession (self-declared) | Primary School Teacher |
| Age at nomination | 51 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=13) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹0 | ₹14.70 Cr | 0.0% | 63 | 57 | 0 | 2026-07-26 |

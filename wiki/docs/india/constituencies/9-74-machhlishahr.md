# Machhlishahr — Lok Sabha, Uttar Pradesh

_`9-74` · मछलीशहर · Reserved for SC · 5 assembly segments_

**[Open Machhlishahr on kaun.city →](https://kaun.city/india/c/9-74)** for the interactive view — the seat
...
| Seat number within the state | 74 |
| Reservation | SC (source: `2008-delimitation-order-table-b`) |
| Name (Hindi) | मछलीशहर |
| Districts | Jaunpur; Varanasi |
| Assembly segments | 5 |
| Wikidata | [Q6723526](https://www.wikidata.org/wiki/Q6723526) |
...
|---:|---|---|---|---|
| 369 | Machhlishahr | SC | Jaunpur | agrees |
| 370 | Mariyahu | — | Jaunpur | agrees |
| 371 | Zafrabad | — | Jaunpur | agrees |
| 372 | Kerakat | SC | Jaunpur | agrees |
| 384 | Pindra | — | Varanasi | agrees |
...
**Priya Saroj** (Samajwadi Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5775) |
...
| Candidate as named on the affidavit | Priya Saroj |
| Pending criminal cases | ⚠ 2 |
| Total assets | ₹11.26 L |
| Liabilities | — |
| Education | Graduate Professional — LLB Amaty University Noida UP In 2022 |
| Profession (self-declared) | Law Business |
| Age at nomination | 25 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=8097) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹6.54 Cr | ₹8.16 Cr | 44.5% | 1366 | 1355 | 725 | 2026-07-26 |

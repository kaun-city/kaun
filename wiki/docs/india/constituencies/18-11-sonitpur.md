# Sonitpur — Lok Sabha, Assam

_`18-11` · तेजपुर · General seat · 9 assembly segments_

**[Open Sonitpur on kaun.city →](https://kaun.city/india/c/18-11)** for the interactive view — the seat
...
| Name (Hindi) | तेजपुर |
| Former name | Tezpur |
| Districts | Sonitpur (86%), Lakhimpur (7%), Nagaon (4%), Golaghat (3%), Jorhat (1%), Marigaon (0%), Udalguri (0%) _(share of the seat's area by district, measured from polygon overlap — this state was re-delimited after 2008 and only the newer order's seat composition was transcribed, without district headings)_ |
| Assembly segments | 9 |
| Wikidata | [Q1606703](https://www.wikidata.org/wiki/Q1606703) |
...
|---:|---|---|---|---|
| 65 | Dhekiajuli | — | — | agrees |
| 66 | Barchalla | — | — | agrees |
| 67 | Tezpur | — | — | agrees |
| 68 | Rangapara | — | — | agrees |
| 69 | Naduar | — | — | not testable |
| 70 | Biswanath | — | — | agrees |
| 71 | Behali | SC | — | agrees |
| 72 | Gohpur | — | — | agrees |
| 73 | Bihpuria | — | — | agrees |
...
**Ranjit Dutta** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5606) |
...
| Candidate as named on the affidavit | Ranjit Dutta |
| Pending criminal cases | none declared |
| Total assets | ₹8.98 Cr |
| Liabilities | ₹2.43 Cr |
| Education | 12th Pass — Pre University from Darrang College Gauhati University in 1975 |
| Profession (self-declared) | MLA |
| Age at nomination | 67 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=741) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹6.16 Cr | ₹8.54 Cr | 41.9% | 144 | 111 | 12 | 2026-07-26 |

# Amethi — Lok Sabha, Uttar Pradesh

_`9-37` · अमेठी · General seat · 5 assembly segments_

**[Open Amethi on kaun.city →](https://kaun.city/india/c/9-37)** for the interactive view — the seat
...
| Name (Hindi) | अमेठी |
| Districts | Rae Bareli; Sultanpur |
| Assembly segments | 5 |
| Wikidata | [Q4745924](https://www.wikidata.org/wiki/Q4745924) |
...
|---:|---|---|---|---|
| 178 | Tiloi | — | Rae Bareli | agrees |
| 181 | Salon | SC | Rae Bareli | agrees |
| 184 | Jagdishpur | SC | Sultanpur | agrees |
| 185 | Gauriganj | — | Sultanpur | agrees |
| 186 | Amethi | — | Sultanpur | agrees |
...
**Kishori Lal** (Indian National Congress) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5546) |
...
| Candidate as named on the affidavit | Kishori Lal |
| Pending criminal cases | none declared |
| Total assets | ₹12.77 Cr |
| Liabilities | ₹4.71 Cr |
| Education | Graduate — B.A. from Punjab University, Chandigarh in 1982 |
| Profession (self-declared) | Business |
| Age at nomination | 62 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7521) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹17.15 Cr | ₹8.01 Cr | ₹9.14 Cr | 46.7% | 50 | 48 | 19 | 2026-08-06 |

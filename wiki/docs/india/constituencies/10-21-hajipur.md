# Hajipur — Lok Sabha, Bihar

_`10-21` · हाजीपुर · Reserved for SC · 6 assembly segments_

**[Open Hajipur on kaun.city →](https://kaun.city/india/c/10-21)** for the interactive view — the seat
...
| Districts | Vaishali |
| Assembly segments | 6 |
| Wikidata | [Q3633148](https://www.wikidata.org/wiki/Q3633148) |
...
|---:|---|---|---|---|
| 123 | Hajipur | — | Vaishali | agrees |
| 124 | Lalganj | — | Vaishali | agrees |
| 126 | Mahua | — | Vaishali | agrees |
| 127 | Raja Pakar | SC | Vaishali | agrees |
| 128 | Raghopur | — | Vaishali | agrees |
| 129 | Mahnar | — | Vaishali | agrees |
...
**Chirag Paswan** (Lok Jan Shakti Party (Ram Vilas)) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/4777) |
...
| Candidate as named on the affidavit | Chirag Paswan |
| Pending criminal cases | none declared |
| Total assets | ₹2.69 Cr |
| Liabilities | — |
| Education | 12th Pass — B.Tech. Second Semester from Computer Engineering Institute of Engineering and Technology Jhansi, Bundelkhand University Jhansi in 2005 |
| Profession (self-declared) | Member of Parliament |
| Age at nomination | 42 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7281) |

# Howrah — Lok Sabha, West Bengal

_`19-25` · हावड़ा · General seat · 7 assembly segments_

**[Open Howrah on kaun.city →](https://kaun.city/india/c/19-25)** for the interactive view — the seat
...
| Districts | Howrah |
| Assembly segments | 7 |
| Wikidata | [Q3348243](https://www.wikidata.org/wiki/Q3348243) |
...
|---:|---|---|---|---|
| 169 | BALLY | — | Howrah | agrees |
| 170 | HOWRAH UTTAR | — | Howrah | agrees |
| 171 | HOWRAH MADHYA | — | Howrah | agrees |
| 172 | SHIBPUR | — | Howrah | agrees |
| 173 | HOWRAH DAKSHIN | — | Howrah | agrees |
| 174 | SANKRAIL | SC | Howrah | agrees |
| 175 | PANCHLA | — | Howrah | agrees |
...
**Prasun Banerjee** (All India Trinamool Congress) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/4583) |
...
| Candidate as named on the affidavit | Prasun Banerjee |
| Pending criminal cases | ⚠ 1 |
| Total assets | ₹1.04 Cr |
| Liabilities | — |
| Education | Graduate — Bachelor of Science Degree from Calcutta University in 1973 |
| Profession (self-declared) | Social Worker |
| Age at nomination | 69 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7195) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹5.95 Cr | ₹8.75 Cr | 40.5% | 217 | 214 | 91 | 2026-07-26 |

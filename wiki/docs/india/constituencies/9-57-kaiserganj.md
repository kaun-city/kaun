# Kaiserganj — Lok Sabha, Uttar Pradesh

_`9-57` · कैसरगंज · General seat · 5 assembly segments_

**[Open Kaiserganj on kaun.city →](https://kaun.city/india/c/9-57)** for the interactive view — the seat
...
| Seat number within the state | 57 |
| Reservation | General (source: `2008-delimitation-order-table-b`) |
| Name (Hindi) | कैसरगंज |
| Districts | Bahraich; Gonda |
| Assembly segments | 5 |
| Wikidata | [Q3634204](https://www.wikidata.org/wiki/Q3634204) |
...
|---:|---|---|---|---|
| 287 | Payagpur | — | Bahraich | agrees |
| 288 | Kaiserganj | — | Bahraich | agrees |
| 297 | Katra Bazar | — | Gonda | agrees |
| 298 | Colonelganj | — | Gonda | agrees |
| 299 | Tarabganj | — | Gonda | agrees |
...
**Karan Bhushan Singh** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5581) |
...
| Candidate as named on the affidavit | Karan Bhushan Singh |
| Pending criminal cases | none declared |
| Total assets | ₹49.57 Cr |
| Liabilities | ₹22.94 Cr |
| Education | Graduate Professional — LLB from Dr. Ram Manohar Lohia Avadh Universtiy, Faizabad in 2018 |
| Profession (self-declared) | Agriculture & Business |
| Age at nomination | 33 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7440) |
...
| Term to date (First Term) | — | — | 92.2% | 51 | 2 | 0 | — |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹9.55 Cr | ₹5.15 Cr | 64.9% | 108 | 98 | 33 | 2026-09-06 |

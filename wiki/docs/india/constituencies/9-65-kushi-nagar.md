# Kushi Nagar — Lok Sabha, Uttar Pradesh

_`9-65` · कुशीनगर · General seat · 5 assembly segments_

**[Open Kushi Nagar on kaun.city →](https://kaun.city/india/c/9-65)** for the interactive view — the seat
...
| Seat number within the state | 65 |
| Reservation | General (source: `2008-delimitation-order-table-b`) |
| Name (Hindi) | कुशीनगर |
| Districts | Kushi Nagar |
| Assembly segments | 5 |
| Wikidata | [Q12420304](https://www.wikidata.org/wiki/Q12420304) |
...
|---:|---|---|---|---|
| 329 | Khadda | — | Kushi Nagar | agrees |
| 330 | Padrauna | — | Kushi Nagar | agrees |
| 333 | Kushinagar | — | Kushi Nagar | agrees |
| 334 | Hata | — | Kushi Nagar | agrees |
| 335 | Ramkola | SC | Kushi Nagar | agrees |
...
**Vijay Kumar Dubey** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5151) |
...
| Candidate as named on the affidavit | Vijay Kumar Dubay |
| Pending criminal cases | ⚠ 2 |
| Total assets | ₹6.02 Cr |
| Liabilities | — |
| Education | 12th Pass — Intermediate In 1980 from Maharana Pratap Intermediate College Gorakhpur |
| Profession (self-declared) | Pension & Agriculture |
| Age at nomination | 57 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=9114) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.89 Cr | ₹7.93 Cr | ₹6.96 Cr | 53.2% | 209 | 179 | 130 | 2026-08-06 |

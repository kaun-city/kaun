# Mandya — Lok Sabha, Karnataka

_`29-20` · मांडया · General seat · 8 assembly segments_

**[Open Mandya on kaun.city →](https://kaun.city/india/c/29-20)** for the interactive view — the seat
...
| Name (Hindi) | मांडया |
| Districts | Mandya; Mysore |
| Assembly segments | 8 |
| Wikidata | [Q5187868](https://www.wikidata.org/wiki/Q5187868) |
...
|---:|---|---|---|---|
| 186 | Malavalli | SC | Mandya | agrees |
| 187 | Maddur | — | Mandya | agrees |
| 188 | Melukote | — | Mandya | agrees |
| 189 | Mandya | — | Mandya | agrees |
| 190 | Srirangapatna | — | Mandya | not testable |
| 191 | Nagamangala | — | Mandya | agrees |
| 192 | Krishnarajpet | — | Mandya | agrees |
| 211 | Krishnarajanagara | — | Mysore | agrees |
...
**H D Kumaraswamy** (Janata Dal (Secular)) holds this seat.
...
| Candidate as named on the affidavit | H.D. Kumaraswamy |
| Pending criminal cases | ⚠ 3 |
| Total assets | ₹217.23 Cr |
| Liabilities | ₹82.19 Cr |
| Education | Graduate — Bachelor of Science 1978 - 79 National College Jayanagar Bangalore University |
| Profession (self-declared) | Social Worker, Politician and Agriculturist |
| Age at nomination | 65 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=2651) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹4.39 Cr | ₹10.30 Cr | 29.9% | 147 | 72 | 0 | 2026-07-26 |

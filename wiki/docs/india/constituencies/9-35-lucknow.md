# Lucknow — Lok Sabha, Uttar Pradesh

_`9-35` · लखनऊ · General seat · 5 assembly segments_

**[Open Lucknow on kaun.city →](https://kaun.city/india/c/9-35)** for the interactive view — the seat
...
| Districts | Lucknow |
| Assembly segments | 5 |
| Wikidata | [Q6697765](https://www.wikidata.org/wiki/Q6697765) |
...
|---:|---|---|---|---|
| 171 | Lucknow West | — | Lucknow | agrees |
| 172 | Lucknow North | — | Lucknow | agrees |
| 173 | Lucknow East | — | Lucknow | agrees |
| 174 | Lucknow Central | — | Lucknow | agrees |
| 175 | Lucknow Cantt | — | Lucknow | agrees |
...
**Rajnath Singh** (Bharatiya Janata Party) holds this seat.
...
| Candidate as named on the affidavit | Raj Nath Singh |
| Pending criminal cases | none declared |
| Total assets | ₹7.37 Cr |
| Liabilities | — |
| Education | Post Graduate — Post Graduate ( Science) in 1971 Gorakhpur University, Graduate (Science) in 1969 KBPG College, Mirzapur Gorakhpur University |
| Profession (self-declared) | Minister Salary, Pension and Agriculture |
| Age at nomination | 72 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7169) |

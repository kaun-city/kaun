# Mirzapur — Lok Sabha, Uttar Pradesh

_`9-79` · मिर्जापुर · General seat · 5 assembly segments_

**[Open Mirzapur on kaun.city →](https://kaun.city/india/c/9-79)** for the interactive view — the seat
...
| Seat number within the state | 79 |
| Reservation | General (source: `2008-delimitation-order-table-b`) |
| Name (Hindi) | मिर्जापुर |
| Districts | Mirzapur |
| Assembly segments | 5 |
| Wikidata | [Q6874958](https://www.wikidata.org/wiki/Q6874958) |
...
|---:|---|---|---|---|
| 395 | Chhanbey | SC | Mirzapur | agrees |
| 396 | Mirzapur | — | Mirzapur | agrees |
| 397 | Majhawan | — | Mirzapur | agrees |
| 398 | Chunar | — | Mirzapur | agrees |
| 399 | Marihan | — | Mirzapur | agrees |
...
**Anupriya Patel** (Apna Dal (Soneylal)) holds this seat.

| Field | Value |
|---|---|
| Name | Anupriya Patel |
| Party | Apna Dal (Soneylal) (Apna Dal (S)) |
| Term | LS18 |
| Status | Sitting |
| Terms served | 3 |
| Age | 45 |
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/4662) |
...
| Candidate as named on the affidavit | Anupriya Patel |
| Pending criminal cases | ⚠ 2 |
| Total assets | ₹4.22 Cr |
| Liabilities | ₹98.06 L |
| Education | Post Graduate — MBA From CSJM University Kanpur Year 2010 |
| Profession (self-declared) | Social Service, Member of Parliament Lok Sabha |
| Age at nomination | 43 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=9380) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹4.31 Cr | ₹10.39 Cr | 29.3% | 10 | 10 | 0 | 2026-08-06 |

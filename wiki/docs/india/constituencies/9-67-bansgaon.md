# Bansgaon — Lok Sabha, Uttar Pradesh

_`9-67` · बांसगांव · Reserved for SC · 5 assembly segments_

**[Open Bansgaon on kaun.city →](https://kaun.city/india/c/9-67)** for the interactive view — the seat
...
| Seat number within the state | 67 |
| Reservation | SC (source: `2008-delimitation-order-table-b`) |
| Name (Hindi) | बांसगांव |
| Districts | Gorakhpur; Deoria |
| Assembly segments | 5 |
| Wikidata | [Q4857123](https://www.wikidata.org/wiki/Q4857123) |
...
|---:|---|---|---|---|
| 326 | Chauri-Chaura | — | Gorakhpur | agrees |
| 327 | Bansgaon | SC | Gorakhpur | agrees |
| 328 | Chillupar | — | Gorakhpur | agrees |
| 336 | Rudrapur | — | Deoria | agrees |
| 342 | Barhaj | — | Deoria | agrees |
...
**Kamlesh Paswan** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/4303) |
...
| Candidate as named on the affidavit | Kamlesh Paswan |
| Pending criminal cases | ⚠ 9 |
| Total assets | ₹36.18 Cr |
| Liabilities | ₹3.53 Cr |
| Education | Graduate — B.A. from D.D.U University Gorakhpur Yaer 2012 |
| Profession (self-declared) | MP, Business |
| Age at nomination | 47 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=8799) |

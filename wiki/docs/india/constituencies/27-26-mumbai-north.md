# Mumbai North — Lok Sabha, Maharashtra

_`27-26` · मुम्बई-उत्तर · General seat · 6 assembly segments_

**[Open Mumbai North on kaun.city →](https://kaun.city/india/c/27-26)** for the interactive view — the seat
...
| Seat number within the state | 26 |
| Reservation | General (source: `2008-delimitation-order-table-b`) |
| Name (Hindi) | मुम्बई-उत्तर |
| Districts | Mumbai Suburban |
| Assembly segments | 6 |
| Wikidata | [Q6935304](https://www.wikidata.org/wiki/Q6935304) |
...
|---:|---|---|---|---|
| 152 | Borivali | — | Mumbai Suburban | agrees |
| 153 | Dahisar | — | Mumbai Suburban | agrees |
| 154 | Magathane | — | Mumbai Suburban | agrees |
| 160 | Kandivali East | — | Mumbai Suburban | agrees |
| 161 | Charkop | — | Mumbai Suburban | agrees |
| 162 | Malad West | — | Mumbai Suburban | agrees |
...
**Piyush Vedprakash Goyal** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5551) |
...
| Candidate as named on the affidavit | Piyush Goyal |
| Pending criminal cases | none declared |
| Total assets | ₹110.95 Cr |
| Liabilities | ₹14.23 Cr |
| Education | Graduate Professional — Chartered Accountant From The Institute of Chartered Accountants of India In The Year 1987, LLB From Government Law College University of Mumbai In The Year 1987 |
| Profession (self-declared) | Chartered Accountant, Presently Cabinet Minister In Government Of India |
| Age at nomination | 59 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7093) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹3.08 Cr | ₹11.62 Cr | 21.0% | 49 | 49 | 0 | 2026-09-06 |

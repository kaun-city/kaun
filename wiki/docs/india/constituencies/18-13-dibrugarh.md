# Dibrugarh — Lok Sabha, Assam

_`18-13` · डिब्रुगढ़ · General seat · 10 assembly segments_

**[Open Dibrugarh on kaun.city →](https://kaun.city/india/c/18-13)** for the interactive view — the seat
...
| Name (Hindi) | डिब्रुगढ़ |
| Districts | Dibrugarh (60%), Tinsukia (38%), Sivasagar (2%), Dhemaji (1%), Changlang (0%) _(share of the seat's area by district, measured from polygon overlap — this state was re-delimited after 2008 and only the newer order's seat composition was transcribed, without district headings)_ |
| Assembly segments | 10 |
| Wikidata | [Q1606690](https://www.wikidata.org/wiki/Q1606690) |
...
|---:|---|---|---|---|
| 83 | Margherita | — | — | agrees |
| 84 | Digboi | — | — | agrees |
| 85 | Makum | — | — | not testable |
| 86 | Tinsukia | — | — | agrees |
| 87 | Chabua-Lahowal | — | — | not testable |
| 88 | Dibrugarh | — | — | agrees |
| 89 | Khowang | — | — | not testable |
| 90 | Duliajan | — | — | agrees |
| 91 | Tingkhong | — | — | agrees |
| 92 | Naharkatia | — | — | agrees |
...
**Sarbananda Sonowal** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/4163) |
...
| Candidate as named on the affidavit | Sarbananda Sonowal |
| Pending criminal cases | none declared |
| Total assets | ₹4.76 Cr |
| Liabilities | ₹25.78 L |
| Education | Graduate Professional — LL.B from G.U Law College Gauhati University, Guwahati in 1996, BCJ(Bachelor of Communication and Journalism) In 1996 from Gauhati University, Guwahati |
| Profession (self-declared) | Presently holding the post of Union Cabinet Minister, Govt of India |
| Age at nomination | 62 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=259) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹1.85 Cr | ₹12.85 Cr | 12.6% | 87 | 58 | 3 | 2026-08-06 |

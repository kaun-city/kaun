# Pilibhit — Lok Sabha, Uttar Pradesh

_`9-26` · पीलीभीत · General seat · 5 assembly segments_

**[Open Pilibhit on kaun.city →](https://kaun.city/india/c/9-26)** for the interactive view — the seat
...
| Name (Hindi) | पीलीभीत |
| Districts | Bareilly; Pilibhit |
| Assembly segments | 5 |
| Wikidata | [Q7193997](https://www.wikidata.org/wiki/Q7193997) |
...
|---:|---|---|---|---|
| 118 | Baheri | — | Bareilly | agrees |
| 127 | Pilibhit | — | Pilibhit | agrees |
| 128 | Barkhera | — | Pilibhit | agrees |
| 129 | Puranpur | SC | Pilibhit | agrees |
| 130 | Bisalpur | — | Pilibhit | agrees |
...
**Jitin Prasada** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/4065) |
...
| Candidate as named on the affidavit | Jitin Prasada |
| Pending criminal cases | none declared |
| Total assets | ₹29.89 Cr |
| Liabilities | — |
| Education | Post Graduate — MBA-International Management Institute,New Delhi 1995-1996, B.Com. Sri Ram Commerce College D.U.1992-1995 |
| Profession (self-declared) | 1.Salary, 2.Rent, 3.Sell of Share, 4.Bank Interest,5.Proffesional Income,6.Bank and FD Interest |
| Age at nomination | 50 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=899) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹3.96 Cr | ₹10.74 Cr | 26.9% | 59 | 53 | 22 | 2026-08-06 |

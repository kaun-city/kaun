# Udhampur — Lok Sabha, Jammu & Kashmir

_`1-4` · उधमपुर · General seat · 18 assembly segments_

**[Open Udhampur on kaun.city →](https://kaun.city/india/c/1-4)** for the interactive view — the seat
...
| Name (Hindi) | उधमपुर |
| Districts | Kishtwar (43%), Kathua (14%), Udhampur (13%), Doda (12%), Ramban (6%), Anantnag (4%), Chamba (4%), Reasi (1%), Samba (1%), Gurdaspur (1%), Jammu (1%), Kargil (1%) _(share of the seat's area by district, measured from polygon overlap — this state was re-delimited after 2008 and only the newer order's seat composition was transcribed, without district headings)_ |
| Assembly segments | 18 |
| Wikidata | [Q7877193](https://www.wikidata.org/wiki/Q7877193) |
...
| 48 | Inderwal | — | — | agrees |
| 49 | Kishtwar | — | — | agrees |
| 50 | Padder-Nagseni | — | — | not testable |
| 51 | Bhadarwah | — | — | not testable |
| 52 | Doda | — | — | agrees |
| 53 | Doda West | — | — | not testable |
| 54 | Ramban | — | — | agrees |
| 55 | Banihal | — | — | agrees |
| 59 | Udhampur West | — | — | not testable |
| 60 | Udhampur East | — | — | not testable |
| 61 | Chenani | — | — | agrees |
| 62 | Ramnagar | SC | — | agrees |
| 63 | Bani | — | — | agrees |
| 64 | Billawar | — | — | agrees |
| 65 | Basohli | — | — | agrees |
| 66 | Jasrota | — | — | not testable |
| 67 | Kathua | SC | — | agrees |
| 68 | Hiranagar | — | — | ⚠ polygon puts it in Jammu & Kashmir 5-Jammu |

_Independent check: 11 of 12 testable segments agree with the polygon geometry; 6 could not be tested. Where the text and the
...
**Jitendra Singh** (Bharatiya Janata Party) holds this seat.
...
| Profession | MEDICAL PRACTITIONER; AUTHOR, Newspaper Columnist, Professor |
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/4718) |
...
| Candidate as named on the affidavit | Dr Jitendra Singh |
| Pending criminal cases | none declared |
| Total assets | ₹8.59 Cr |
| Liabilities | — |
| Education | Post Graduate — MD from Govt. Medical College, Jammu, University of Jammu In 1984, MBBS from Stanley College Madras (Chennai) University of Madras In 1978 |
| Profession (self-declared) | Retired Professor of Medicine GMC Jammu, At Present Minister of State (Independent Charge) Science & Tech, Mos In Prime Minister office , Do P&T Department of space & Atomic Energy Govt of India |
| Age at nomination | 67 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=8) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹4.57 Cr | ₹10.13 Cr | 31.1% | 329 | 306 | 184 | 2026-08-06 |

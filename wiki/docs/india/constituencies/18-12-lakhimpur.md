# Lakhimpur — Lok Sabha, Assam

_`18-12` · लखीमपुर · General seat · 9 assembly segments_

**[Open Lakhimpur on kaun.city →](https://kaun.city/india/c/18-12)** for the interactive view — the seat
...
| Name (Hindi) | लखीमपुर |
| Districts | Dhemaji (38%), Lakhimpur (36%), Tinsukia (24%), Dibrugarh (1%), West Siang (1%) _(share of the seat's area by district, measured from polygon overlap — this state was re-delimited after 2008 and only the newer order's seat composition was transcribed, without district headings)_ |
| Assembly segments | 9 |
| Wikidata | [Q1609659](https://www.wikidata.org/wiki/Q1609659) |
...
|---:|---|---|---|---|
| 74 | Rongonadi | — | — | not testable |
| 75 | Nowboicha | SC | — | not testable |
| 76 | Lakhimpur | — | — | agrees |
| 77 | Dhakuakhana | ST | — | agrees |
| 78 | Dhemaji | ST | — | agrees |
| 79 | Sissibargaon | — | — | not testable |
| 80 | Jonai | ST | — | agrees |
| 81 | Sadiya | — | — | agrees |
| 82 | Doomdooma | — | — | agrees |

_Independent check: 6 of 6 testable segments agree with the polygon geometry; 3 could not be tested. Where the text and the
...
**Pradan Baruah** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/4937) |
...
| Candidate as named on the affidavit | Pradan Baruah |
| Pending criminal cases | none declared |
| Total assets | ₹2.42 Cr |
| Liabilities | ₹22.70 L |
| Education | Others — Diploma in Mech. Engg. in 1985 From Dibrugarh Polytechnic Assam |
| Profession (self-declared) | Social Worker And Farmer |
| Age at nomination | 58 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=239) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹5.42 Cr | ₹9.28 Cr | 36.9% | 147 | 113 | 0 | 2026-07-26 |

# Kanthi — Lok Sabha, West Bengal

_`19-31` · कांथी · General seat · 7 assembly segments_

**[Open Kanthi on kaun.city →](https://kaun.city/india/c/19-31)** for the interactive view — the seat
...
| Assembly segments | 7 |
| Wikidata | [Q3351410](https://www.wikidata.org/wiki/Q3351410) |
...
|---:|---|---|---|---|
| 211 | CHANDIPUR | — | Purbo Medinipur | agrees |
| 212 | PATASHPUR | — | Purbo Medinipur | agrees |
| 213 | KANTHI UTTAR | — | Purbo Medinipur | agrees |
| 214 | BHAGABANPUR | — | Purbo Medinipur | agrees |
| 215 | KHEJURI | SC | Purbo Medinipur | agrees |
| 216 | KANTHI DAKSHIN | — | Purbo Medinipur | agrees |
| 217 | RAMNAGAR | — | Purbo Medinipur | agrees |
...
**Adhikari Soumendu** (Bharatiya Janata Party) holds this seat.
...
| Profession | Social Activist; BUSINESSPERSON |
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5659) |
...
| Candidate as named on the affidavit | Adhikari Soumendu |
| Pending criminal cases | ⚠ 6 |
| Total assets | ₹2.62 Cr |
| Liabilities | ₹2.88 L |
| Education | Post Graduate — Post Graduate MA from Vidyasagar University 2010 |
| Profession (self-declared) | Business & Social Worker |
| Age at nomination | 41 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7922) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹3.83 Cr | ₹10.87 Cr | 26.1% | 70 | 66 | 29 | 2026-07-26 |

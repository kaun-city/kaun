# Guwahati — Lok Sabha, Assam

_`18-5` · गुवाहाटी · General seat · 10 assembly segments_

**[Open Guwahati on kaun.city →](https://kaun.city/india/c/18-5)** for the interactive view — the seat
...
| Name (Hindi) | गुवाहाटी |
| Districts | Kamrup (44%), Kamrup Metropolitan (28%), Goalpara (27%), East Garo Hills (0%), Ri Bhoi (0%) _(share of the seat's area by district, measured from polygon overlap — this state was re-delimited after 2008 and only the newer order's seat composition was transcribed, without district headings)_ |
| Assembly segments | 10 |
| Wikidata | [Q1606633](https://www.wikidata.org/wiki/Q1606633) |
...
|---:|---|---|---|---|
| 13 | Goalpara West | ST | — | ⚠ polygon puts it in Assam 2-Dhubri |
| 15 | Dudhnai | ST | — | agrees |
| 27 | Chamaria | — | — | not testable |
| 28 | Boko-Chaygaon | ST | — | not testable |
| 29 | Palasbari | — | — | agrees |
| 33 | Dispur | — | — | agrees |
| 34 | Dimoria | SC | — | not testable |
| 35 | New Guwahati | — | — | not testable |
| 36 | Guwahati Central | — | — | not testable |
| 37 | Jalukbari | — | — | ⚠ polygon puts it in Assam 4-Darrang Udalguri |

_Independent check: 3 of 5 testable segments agree with the polygon geometry; 5 could not be tested. Where the text and the
...
**Bijuli Kalita Medhi** (Bharatiya Janata Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5603) |
...
| Candidate as named on the affidavit | Bijuli Kalita Medhi |
| Pending criminal cases | none declared |
| Total assets | ₹1.62 Cr |
| Liabilities | — |
| Education | Post Graduate — M.A. in Philosophy in 2002 from University of Guwahati |
| Profession (self-declared) | Business (Handloom and Handicraft Items) |
| Age at nomination | 45 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=4548) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹7.60 Cr | ₹7.10 Cr | 51.7% | 150 | 101 | 5 | 2026-09-06 |

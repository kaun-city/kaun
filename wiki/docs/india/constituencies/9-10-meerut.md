# Meerut — Lok Sabha, Uttar Pradesh

_`9-10` · मेरठ · General seat · 5 assembly segments_

**[Open Meerut on kaun.city →](https://kaun.city/india/c/9-10)** for the interactive view — the seat
...
| Assembly segments | 5 |
| Wikidata | [Q12447565](https://www.wikidata.org/wiki/Q12447565) |
...
|---:|---|---|---|---|
| 46 | Kithore | — | Meerut | agrees |
| 47 | Meerut Cant | — | Meerut | not testable |
| 48 | Meerut | — | Meerut | agrees |
| 49 | Meerut South | — | Meerut | agrees |
| 59 | Hapur | SC | Ghaziabad | agrees |
...
**Arun Govil** (Bharatiya Janata Party) holds this seat.
...
| Profession | Self Employed; Actor |
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5564) |
...
| Candidate as named on the affidavit | Arun Govil |
| Pending criminal cases | none declared |
| Total assets | ₹14.44 Cr |
| Liabilities | ₹14.64 L |
| Education | Graduate — B.Sc. from G F College Shahjahanpur, Agra University in 1972 |
| Profession (self-declared) | Constultancy, Rent, Bank Interest & Profit |
| Age at nomination | 72 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=1923) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹6.52 Cr | ₹8.18 Cr | 44.3% | 232 | 117 | 36 | 2026-08-06 |

# Basirhat — Lok Sabha, West Bengal

_`19-18` · बसीरहाट · General seat · 7 assembly segments_

**[Open Basirhat on kaun.city →](https://kaun.city/india/c/19-18)** for the interactive view — the seat
...
| Assembly segments | 7 |
| Wikidata | [Q4867561](https://www.wikidata.org/wiki/Q4867561) |
...
|---:|---|---|---|---|
| 99 | BADURIA | — | North 24 Parganas | agrees |
| 121 | HAROA | — | North 24 Parganas | agrees |
| 122 | MINAKHAN | SC | North 24 Parganas | agrees |
| 123 | SANDESHKHALI | ST | North 24 Parganas | agrees |
| 124 | BASIRHAT DAKSHIN | — | North 24 Parganas | agrees |
| 125 | BASIRHAT UTTAR | — | North 24 Parganas | agrees |
| 126 | HINGALGANJ | SC | North 24 Parganas | agrees |
...
|---|---|---|---|
| Nurul Islam ([profile](https://sansad.in/ls/members/biography/4490)) | All India Trinamool Congress | Died | LS18 |

_Nurul Islam is recorded with status `Died`. The database enforces at most one sitting member per seat, so a predecessor row can never be mistaken for the incumbent._
...
| Candidate as named on the affidavit | Sk Nurul Islam |
| Pending criminal cases | none declared |
| Total assets | ₹1.60 Cr |
| Liabilities | — |
| Education | 12th Pass — Alim Passed From Kharki Islamia Senior Madrasah Year 1977 |
| Profession (self-declared) | Politician and Business |
| Age at nomination | 61 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=8990) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹4.90 Cr | ₹3.07 Cr | ₹1.83 Cr | 62.7% | 32 | 17 | 6 | 2026-08-06 |

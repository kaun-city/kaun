# Sultanpur — Lok Sabha, Uttar Pradesh

_`9-38` · सुल्तानपुर · General seat · 5 assembly segments_

**[Open Sultanpur on kaun.city →](https://kaun.city/india/c/9-38)** for the interactive view — the seat
...
| Name (Hindi) | सुल्तानपुर |
| Districts | Sultanpur |
| Assembly segments | 5 |
| Wikidata | [Q7636812](https://www.wikidata.org/wiki/Q7636812) |
...
|---:|---|---|---|---|
| 187 | Isauli | — | Sultanpur | agrees |
| 188 | Sultanpur | — | Sultanpur | agrees |
| 189 | Sadar | — | Sultanpur | agrees |
| 190 | Lambhua | — | Sultanpur | agrees |
| 191 | Kadipur | SC | Sultanpur | agrees |
...
**Rambhual Nishad** (Samajwadi Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5786) |
...
| Candidate as named on the affidavit | Rambhual Nishad |
| Pending criminal cases | ⚠ 8 |
| Total assets | ₹3.74 Cr |
| Liabilities | ₹3.63 L |
| Education | Graduate — Graduate BA from National Degree College Badhalganj Gorakhpur, Gorakhpur University Gorakhpur In 1984 |
| Profession (self-declared) | Income From Agricultural Produce & Politician Pension |
| Age at nomination | 64 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=8073) |
...
| Term to date (First Term) | — | — | 85.2% | 23 | 3 | 0 | — |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹15.12 Cr | ₹7.72 Cr | ₹7.41 Cr | 51.0% | 52 | 32 | 0 | 2026-07-26 |

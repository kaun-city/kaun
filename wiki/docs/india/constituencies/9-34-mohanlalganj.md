# Mohanlalganj — Lok Sabha, Uttar Pradesh

_`9-34` · मोहनलाल गंज · Reserved for SC · 5 assembly segments_

**[Open Mohanlalganj on kaun.city →](https://kaun.city/india/c/9-34)** for the interactive view — the seat
...
| Name (Hindi) | मोहनलाल गंज |
| Districts | Sitapur; Lucknow |
| Assembly segments | 5 |
| Wikidata | [Q3823603](https://www.wikidata.org/wiki/Q3823603) |
...
|---:|---|---|---|---|
| 152 | Sidhauli | SC | Sitapur | agrees |
| 168 | Malihabad | SC | Lucknow | agrees |
| 169 | Bakshi Kaa Talab | — | Lucknow | agrees |
| 170 | Sarojini Nagar | — | Lucknow | agrees |
| 176 | Mohanlalganj | SC | Lucknow | agrees |
...
**R K Chaudhary** (Samajwadi Party) holds this seat.
...
| Official profile | [sansad.in](https://sansad.in/ls/members/biography/5803) |
...
| Candidate as named on the affidavit | R.K. Chaudhary |
| Pending criminal cases | ⚠ 2 |
| Total assets | ₹2.84 Cr |
| Liabilities | — |
| Education | Graduate Professional — LLB from KS. Saket College, Faizabad Avadh University In 1977, B.Sc From KS. Saket College, Faizabad Avadh University In 1973 |
| Profession (self-declared) | Pensioner & Agricultre |
| Age at nomination | 65 |
| Affidavit source | [myneta.info](https://myneta.info/LokSabha2024/candidate.php?candidate_id=7161) |
...
| Term to date (First Term) | — | — | 92.2% | 21 | 4 | 0 | — |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| eSAKSHI (official) | ₹14.70 Cr | ₹3.46 Cr | ₹11.24 Cr | 23.6% | 92 | 74 | 14 | 2026-08-06 |
